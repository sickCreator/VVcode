        ...
        buton1.setOnClickListener((new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if(radioGroup.getCheckedRadioButtonId()==-1){
                            Toast.makeText(Quiz1.this, "please select a radio button", Toast.LENGTH_SHORT).show();
                            return;
                        }
                        ...
                        if(count<questions.length){
                            ...
                            DocumentReference documentReference=fStore.collection("score").document("Quiz");
                            ...
                            Toast.makeText(Quiz1.this, "correct answer : "+correct+"\nwrong answer"+wrong, Toast.LENGTH_LONG).show();
