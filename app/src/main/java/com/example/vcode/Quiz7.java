        ...
        buton1.setOnClickListener((new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (radioGroup.getCheckedRadioButtonId() == -1) {
                            Toast.makeText(Quiz7.this, "please select a radio button", Toast.LENGTH_SHORT).show();
                            return;
                        }
                        ...
                        if (ans == answers[count]) {
                            correct++;
                            Toast.makeText(Quiz7.this, "correct answer", Toast.LENGTH_SHORT).show();
                        ...
                        if (count < questions.length) {
                            ...
                            Toast.makeText(Quiz7.this, "correct answer : " + correct + "\nwrong answer" + wrong, Toast.LENGTH_LONG).show();
